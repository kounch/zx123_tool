...
def build_menubar(self: Any):
    """Add Menu Bar"""

    help_url: str = 'https://kounch.github.io/zx123_tool/manual.html'
    ...
    updatemenu: tk.Menu = tk.Menu(menubar, tearoff=0)
    ...
    helpmenu: tk.Menu = tk.Menu(menubar, tearoff=0)
    ...
    core_menu: tk.Menu = tk.Menu(self, tearoff=0)
    ...
    rom_menu: tk.Menu = tk.Menu(self, tearoff=0)
    rom_menu.add_command(label="Rename", command=self.rom_rename)
    self.rom_menu = rom_menu

    json_menu: tk.Menu = tk.Menu(self, tearoff=0)
...
def bind_keys(self: Any, *_: Any):
    """Bind Menu Keys"""

    str_bind: str = 'Control-'
    if sys.platform == 'win32':
        str_bind = 'Control-'
    elif sys.platform == 'darwin':
        str_bind = 'Command-'
...
def core_menu_popup(self: Any, event: Any):
...
def rom_menu_popup(self: Any, event: Any):
...
def json_menu_popup(self: Any, event: Any):
...
def create_labels(self: Any) -> tuple[ttk.Label, Optional[ttk.Label]]:
    """
    ...
    version_label: Optional[ttk.Label] = None
    ...
    bios_label: ttk.Label = ttk.Label(self.blocks_frame,
                                      text='BIOS:',
                                      padding=5)
    bios_label.grid(column=0, row=1, sticky='e')

    esxdos_label: ttk.Label = ttk.Label(self.blocks_frame,
                                        text='esxdos:',
                                        padding=5)
    esxdos_label.grid(column=4, row=1, sticky='e')

    spectrum_label: ttk.Label = ttk.Label(self.blocks_frame,
                                          text='ZX Spectrum Core:',
                                          padding=5)
    spectrum_label.grid(column=0, row=2, sticky='e')

    cores_label: ttk.Label = ttk.Label(self.cores_frame, text='Cores')
    cores_label.grid(column=0, row=0, sticky='w')

    core_label: ttk.Label = ttk.Label(self.cores_frame,
                                      text='Default Core:',
                                      padding=5)
    core_label.grid(column=3, row=1, sticky='e')

    boot_label: ttk.Label = ttk.Label(self.cores_frame,
                                      text='Boot Timer:',
                                      padding=5)
    boot_label.grid(column=3, row=2, sticky='e')

    keyboard_label: ttk.Label = ttk.Label(self.cores_frame,
                                          text='Keyboard Layout:',
                                          padding=5)
    keyboard_label.grid(column=3, row=3, sticky='e')

    video_label: ttk.Label = ttk.Label(
        self.cores_frame,
        text='Video Mode:',
        padding=5,
    )
    ...
    rom_label: ttk.Label = ttk.Label(self.cores_frame,
                                     text='Default ROM:',
                                     padding=5)
    rom_label.grid(column=3, row=5, sticky='e')

    roms_label: ttk.Label = ttk.Label(self.roms_frame, text='ROMs')
    roms_label.grid(column=0, row=0, sticky='w')

    return image_label, version_label


def create_entries(self: Any):
    """Create Main Window Input Fields"""

    self.bios = tk.StringVar()
    bios_entry: ttk.Entry = ttk.Entry(self.blocks_frame,
                                      width=10,
                                      state='disabled',
    ...
    esxdos_entry: ttk.Entry = ttk.Entry(self.blocks_frame,
                                        width=5,
                                        state='disabled',
    ...
    spectrum_entry: ttk.Entry = ttk.Entry(self.blocks_frame,
                                          state='disabled',
    ...
    core_spinbox: ttk.Spinbox = ttk.Spinbox(self.cores_frame,
                                            from_=1,
                                            to=1,
                                            wrap=False,
                                            width=4,
    ...
    timer_spinbox: ttk.Spinbox = ttk.Spinbox(
        self.cores_frame,
        from_=0,
        to=4,
        wrap=False,
    ...
    keyboard_spinbox: ttk.Spinbox = ttk.Spinbox(
        self.cores_frame,
        from_=0,
        to=3,
        wrap=False,
    ...
    video_spinbox: ttk.Spinbox = ttk.Spinbox(
        self.cores_frame,
        from_=0,
        to=2,
        wrap=False,
    ...
    rom_spinbox: ttk.Spinbox = ttk.Spinbox(self.cores_frame,
                                           from_=0,
                                           to=0,
                                           wrap=False,
                                           width=4,
...
def create_core_table(self: Any) -> ttk.Treeview:
    """
    ...
    core_table: ttk.Treeview = ttk.Treeview(self.cores_frame, height=11)
    ...
    col_sizes: list[int] = [30, 240, 200, 250]
    ...
    core_scrollbar: ttk.Scrollbar = ttk.Scrollbar(self.cores_frame,
                                                  orient=tk.VERTICAL,
...
def create_rom_table(self: Any, height: int = 11) -> ttk.Treeview:
    """
    Create ROMs Table
    :return: Reference to rom_table
    """
    rom_table: ttk.Treeview = ttk.Treeview(self.roms_frame, height=height)
    ...
    col_sizes: list[int] = [30, 30, 80, 155, 280, 40, 300]
...
def create_buttons(self: Any):
    ...
    bios_import_button: ttk.Button = ttk.Button(self.blocks_frame,
                                                text='Import BIOS',
                                                state='disabled',
    ...
    bios_export_button: ttk.Button = ttk.Button(self.blocks_frame,
                                                text='Export BIOS',
                                                state='disabled',
    ...
    esxdos_import_button: ttk.Button = ttk.Button(self.blocks_frame,
                                                  text='Import esxdos',
                                                  state='disabled',
    ...
    esxdos_export_button: ttk.Button = ttk.Button(self.blocks_frame,
                                                  text='Export esxdos',
                                                  state='disabled',
    ...
    spectrum_import_button: ttk.Button = ttk.Button(
        self.blocks_frame,
    ...
    spectrum_export_button: ttk.Button = ttk.Button(
        self.blocks_frame,
    ...
    core_import_button: ttk.Button = ttk.Button(self.cores_frame,
                                                text='Add New Core',
                                                state='disabled',
    ...
    core_export_button: ttk.Button = ttk.Button(self.cores_frame,
                                                text='Export Core',
                                                state='disabled',
    ...
    rom_import_button: ttk.Button = ttk.Button(self.roms_frame,
                                               text='Add New ROM',
                                               state='disabled')
    ...
    rom_export_button: ttk.Button = ttk.Button(self.roms_frame,
                                               text='Export ROM',
                                               state='disabled',
    ...
    rompack_import_button: ttk.Button = ttk.Button(self.roms_frame,
                                                   text='Import ROMPack...',
                                                   state='disabled',
    ...
    rompack_export_button: ttk.Button = ttk.Button(self.roms_frame,
                                                   text='Export ROMPack...',
                                                   state='disabled',
...
def populate_cores(self: Any, dict_cores: dict[str, Any]):
    """
...
def populate_roms(self: Any, dict_roms: dict[str, Any]):
    """
...
def changed_bios_spinbox(
        self: Any,  # pylint: disable=unused-argument
        bios_value: tk.StringVar,
        min_val: int,
        max_val: int):
    """
    ...
    if str_new_val.isnumeric():
        new_val = int(str_new_val)
        new_val = max(new_val, min_val)
        new_val = min(new_val, max_val)
    else:
        new_val = min_val

    bios_value.set(str(new_val))


def changed_core_spinbox(self: Any, *_: Any):
...
def process_selected(self: Any, treeview: ttk.Treeview, treeview_menu: tk.Menu,
                     import_bttn: ttk.Button, export_bttn: ttk.Button,
                     str_text: str):
    """
        Configure buttons according to the selections sent by ..._selected...
        :param treeview: Origin of the selection event
        :param treeview_menu: Reference to popup menu
    ...
    t_selection: tuple[Any] = treeview.selection()
    if t_selection:
...
def coretable_selected(self: Any, *_: Any):
    """
...
def romtable_selected(self: Any, *_: Any):
    """
